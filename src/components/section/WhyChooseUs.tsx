      ...
      >
        ...
        >
          <motion.div
            ...
            className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-rose-500/10 border border-rose-500/20 mb-4 md:mb-6"
          >
              ...
              >
                ...
                <div className="relative h-full p-3 rounded-xl bg-white/[0.02] border border-white/[0.05] backdrop-blur-sm active:bg-white/[0.04] active:border-white/[0.1] transition-all duration-300">
                  ...
                  <div className="relative flex-shrink-0 mb-2">
                    <div className="w-10 h-10 rounded-lg bg-gradient-to-br from-indigo-500/20 to-rose-500/20 flex items-center justify-center group-active:scale-105 transition-transform duration-300">
                    ...
                    <motion.div
                      ...
                      className="absolute -top-1 -right-1 px-2 py-0.5 rounded-full bg-gradient-to-r from-indigo-500 to-rose-500 text-white text-[10px] font-bold shadow-md"
                    >
                      {reason.stat}
                    </motion.div>
                  </div>
                  ...
                  <div className="flex-1 min-w-0">
                    {/* Title */}
                    <h3 className="text-xs font-semibold mb-1 text-white group-active:text-indigo-300 transition-colors duration-300 leading-tight">
                      {reason.title}
                    </h3>
                ...
                {/* Bottom accent line */}
                <div className="absolute bottom-0 left-0 right-0 h-0.5 rounded-b-xl opacity-0 group-active:opacity-100 transition-opacity duration-300 bg-gradient-to-r from-indigo-500 to-rose-500" />
              </motion.div>
            );
          })}
        </div>
        ...
        <div className="hidden md:grid grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
          {reasons.map((reason, index) => {
            ...
            return (
              ...
              >
                <div className="relative h-full p-6 lg:p-8 rounded-2xl bg-white/[0.02] border border-white/[0.05] backdrop-blur-sm hover:bg-white/[0.04] hover:border-white/[0.1] transition-all duration-300">
                  {/* Icon with gradient background */}
                  <div className="relative mb-6">
                    <div className="w-14 h-14 lg:w-16 lg:h-16 rounded-2xl bg-gradient-to-br from-indigo-500/20 to-rose-500/20 flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                    ...
                    <motion.div
                      ...
                      animate={inView ? { scale: 1 } : {}}
                      transition={{ duration: 0.5, delay: 0.8 + index * 0.1 }}
                      className="absolute -top-2 -right-2 px-3 py-1 rounded-full bg-gradient-to-r from-indigo-500 to-rose-500 text-white text-xs font-bold shadow-lg"
                    >
                      {reason.stat}
                    </motion.div>
                  </div>
                ...
                {/* Corner accent */}
                <div className="absolute top-0 right-0 w-20 h-20 bg-gradient-to-br from-indigo-500/10 to-transparent rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
              </motion.div>
            );
          })}
        </div>
