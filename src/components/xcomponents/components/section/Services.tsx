              ...
              <div className="relative">
                <span className="flex flex-row sm:flex-col">
                  <motion.div
                    ...
                    className="bg-primary/10 rounded-full h-14 w-14 sm:h-16 sm:w-16 flex items-center justify-center mb-0 sm:mb-4 shrink-0 group-hover:bg-primary/20 transition-colors duration-300"
                  >
                    {service.icon}
                  </motion.div>
...
//         <div className="absolute bottom-1/4 right-1/4 w-48 h-48 bg-cyber-blue/10 rounded-full blur-2xl animate-pulse-slower" />
//       </div>
...
//           <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-4 text-gradient bg-linear-to-r from-white to-cyber-blue bg-clip-text text-transparent">
//             Services
//           </h2>
//           <p className="text-base md:text-lg text-muted-foreground max-w-2xl mx-auto leading-relaxed mb-[-30px]">
//             I offer a wide range of services to help you build your digital
...
//               whileHover="hover"
//               className="glass-morphism p-6 md:p-8 rounded-xl group relative overflow-hidden border border-white/5 backdrop-blur-sm hover:border-primary/20 transition-all duration-300"
//             >
//               {/* Enhanced gradient overlay */}
//               <div className="absolute inset-0 bg-gradient-to-br from-primary/8 via-transparent to-cyber-blue/5 opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
...
//                     className="bg-primary/10 rounded-full h-14 w-14 sm:h-16 sm:w-16 flex items-center justify-center mb-0 sm:mb-4 shrink-0 group-hover:bg-primary/20 transition-colors duration-300 border border-primary/20"
//                   >
//                     {service.icon}
//                   </motion.div>
//                   <h3 className="text-lg sm:text-xl md:text-2xl font-semibold mb-2 sm:mb-3 mt-4 sm:mt-0 ml-3 sm:ml-0 group-hover:text-primary transition-colors duration-300 text-white">
//                     {service.title}
//                   </h3>
//                 </div>
