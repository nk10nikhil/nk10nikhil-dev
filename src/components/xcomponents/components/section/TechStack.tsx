...
const TechStack = () => {
  ...
  return (
    <section className="py-16 md:py-16 bg-linear-to-b from-background to-secondary/30 overflow-visible">
...
// const TechIcon = lazy(() => import("./TechIcon"));

// // Memoized technologies data
...
//   const handleLearnMore = useCallback((link: string, e: React.MouseEvent) => {
//     e.stopPropagation();
//     window.open(link, "_blank", "noopener,noreferrer");
//   }, []);
...
//   return (
//     <section className="py-12 md:py-16 bg-gradient-to-b from-background to-secondary/30 overflow-visible">
//       <div className="container mx-auto px-4 md:px-6">
//         <motion.div
...
//           <h2 className="text-2xl md:text-3xl font-bold mb-3 heading-gradient">
//             <div className="inline-flex items-center gap-0 px-0 py-1">
//               <motion.span
//                 animate={{ rotate: 0 }}
...
//               transition={{ delay: index * 0.03, duration: 0.3 }} // Reduced delay and duration
//               onHoverStart={() => handleHoverStart(tech.name)}
//               onHoverEnd={handleHoverEnd}
//               onClick={() => handleClick(tech.name)}
//               className="flex flex-col items-center cursor-pointer"
...
//                           : window.innerWidth < 768
//                           ? "80vw"
//                           : "380px" // Slightly reduced
//                         : "64px", // Smaller base size
//                     height:
//                       activeTech === tech.name && !isExiting
//                         ? window.innerWidth < 640
//                           ? "150px"
//                           : "180px" // Reduced height
//                         : "64px",
//                   }}
//                   transition={{
...
//                         : 0,
//                   }}
//                   className="absolute top-0 left-1/2 -translate-x-1/2 rounded-xl glass-morphism flex items-center justify-center overflow-visible will-change-transform"
//                   style={{
//                     zIndex: activeTech === tech.name ? 50 : 1,
//                   }}
//                 >
//                   {/* Optimized Circle Effect */}
//                   <motion.div
//                     className="absolute inset-0 rounded-xl flex items-center justify-center"
//                     style={{
//                       background:
...
//                     transition={{
//                       duration: 0.25,
//                       delay: activeTech === tech.name && !isExiting ? 0.3 : 0,
//                     }}
//                   >
//                     <motion.div
//                       className="absolute rounded-full border-6 md:border-8" // Reduced border on mobile
//                       style={{
//                         borderColor: tech.color,
//                         filter: `drop-shadow(0 0 8px ${tech.color}) drop-shadow(0 0 40px ${tech.color})`, // Reduced glow
//                       }}
//                       animate={{
//                         borderRadius:
//                           activeTech === tech.name && !isExiting
...
//                       scale: activeTech === tech.name && !isExiting ? 0 : 1,
//                       width:
//                         activeTech === tech.name && !isExiting ? "0px" : "40px", // Smaller icons
//                       height:
//                         activeTech === tech.name && !isExiting ? "0px" : "40px",
//                     }}
//                     transition={{
...
//                   {/* Large Icon on Hover - Only on desktop for performance */}
//                   <AnimatePresence>
//                     {activeTech === tech.name && !isExiting && (
//                       <motion.img
//                         src={tech.icon}
//                         alt={tech.name}
//                         className="absolute hidden lg:block" // Only show on large screens
//                         style={{
//                           filter: "brightness(0) invert(1)",
//                         }}
//                         initial={{
...
//                           scale: 1,
//                           rotate: 15,
//                           width: "120px", // Smaller large icon
//                           height: "120px",
//                         }}
//                         exit={{
//                           scale: 0,
...
//                     {activeTech === tech.name && (
//                       <motion.div
//                         className="absolute left-3 md:left-6 top-0 w-[85%] md:w-[50%] p-3 z-20"
...
//                                 handleClose();
//                               }}
//                               className="text-white/80 hover:text-white text-xl leading-none md:hidden"
//                             >
//                               ×
//                             </button>
//                           )}
//                         </div>
//                         <p className="text-white/90 text-xs mb-2 leading-relaxed line-clamp-3">
//                           {tech.description}
//                         </p>
//                         <button
//                           onClick={(e) => handleLearnMore(tech.link, e)}
//                           className="inline-block bg-white/20 text-white px-3 py-1 rounded text-xs font-semibold hover:bg-white/30 transition-colors cursor-pointer"
//                         >
//                           Learn More →
//                         </button>
//                       </motion.div>
...
//                 ease: "easeInOut",
//               }}
//               className="inline-block mt-1 text-xl"
//             >
//               🚀
//             </motion.div>
//           </p>
