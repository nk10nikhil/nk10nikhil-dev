    ...
    <StyledWrapper>
      <div className="container">
        ...
        >
          ...
          >
            ...
            <g>
              <path
                className="st0"
                d="M512,241.271h-42.912c-14.446,0-25.497-0.274-36.443,8.485c-9.542,7.631-13.326,16.335-21.618,27.974
		...
		c0,21.972-7.72,43.332-22.061,60.746L283.332,280.408z"
              ...
              <path
                className="st0"
                d="M293.1,137.492l-24.101-1.089l-8.494-22.585c-0.702-1.879-2.501-3.13-4.509-3.13
...
//   .container:hover .glass {
//     animation: ${smoothHover} 0.4s ease-out forwards;
//     margin: 0 15px;
//     box-shadow: 0 20px 35px rgba(0, 0, 0, 0.3), 0 8px 15px rgba(0, 0, 0, 0.15);
