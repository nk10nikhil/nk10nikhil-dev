...
import RotateCube from "@/components/items/RotateCube";
...
// // Social media data for better maintainability
// const socialLinks = [
//   {
//     href: "https://www.instagram.com/nk10nikhil",
//     title: "Instagram",
...
//     href: "https://www.linkedin.com/in/nk10nikhil",
//     title: "LinkedIn",
//     color: "linear-gradient(#bf66ff, #6248ff, #00ddeb)",
//     icon: (
//       <svg
//         viewBox="0 0 100 100"
//         height="23px"
...
//         className="social-icon"
//       >
//         <path d="M22.23,0C9.95,0,0,9.95,0,22.23v55.54C0,90.05,9.95,100,22.23,100h55.54C90.05,100,100,90.05,100,77.77V22.23C100,9.95,90.05,0,77.77,0H22.23z M30.34,84.48H15.67V38.1h14.67V84.48z M23.01,31.92c-4.69,0-8.49-3.8-8.49-8.49s3.8-8.49,8.49-8.49c4.69,0,8.49,3.8,8.49,8.49S27.7,31.92,23.01,31.92z M84.48,84.48H69.81V61.26c0-5.55-0.1-12.68-7.72-12.68c-7.72,0-8.9,6.03-8.9,12.26v23.64H38.52V38.1h14.08v6.34h0.2c1.96-3.72,6.75-7.64,13.91-7.64c14.88,0,17.63,9.8,17.63,22.54V84.48z" />
//       </svg>
//     ),
//   },
//   {
...
//   },
//   {
//     href: "https://www.github.com/nk10nikhil",
//     title: "GitHub",
//     color: "black",
//     icon: (
//       <svg
...
//     color: "#ff4500",
//     icon: (
//       <svg viewBox="0 0 256 256" height={30} width={30} className="social-icon">
...
// .social-card-1 { border-top-left-radius: 10px; }
// .social-card-3 { border-top-right-radius: 10px; }
// .social-card-7 { border-bottom-left-radius: 10px; }
// .social-card-9 { border-bottom-right-radius: 10px; }
...
// .social-grid:hover .social-icon {
//   opacity: 1;
// }

// .social-grid:hover .social-text {
//   opacity: 0;
//   pointer-events: none;
// }

// /* Individual hover effects */
// .social-card-1:hover { background-color: #cc39a4 !important; }
// .social-card-1:hover .social-icon { fill: white; }

// .social-card-2:hover { background-color: #03a9f4 !important; }
// .social-card-2:hover .social-icon { fill: white; }

// .social-card-3:hover { background-color: #243c5a !important; }
// .social-card-3:hover .social-icon { fill: white; }

// .social-card-4:hover { background-color: red !important; }
// .social-card-4:hover .social-icon { fill: white; }

// .social-card-5:hover {
//   background: linear-gradient(#bf66ff, #6248ff, #00ddeb) !important;
//   border: transparent !important;
// }
// .social-card-5:hover .social-icon stop { stop-color: white; }

// .social-card-6:hover { background-color: #8c9eff !important; }
// .social-card-6:hover .social-icon { fill: white; }

// .social-card-7:hover { background-color: black !important; }
// .social-card-7:hover .social-icon { fill: white; }

// .social-card-8:hover { background-color: #29b6f6 !important; }
// .social-card-8:hover .social-icon path:nth-of-type(1) { fill: white; }
// .social-card-8:hover .social-icon path:nth-of-type(2),
// .social-card-8:hover .social-icon path:nth-of-type(3) { fill: #29b6f6; }

// .social-card-9:hover { background-color: #ff4500 !important; }
// .social-card-9:hover .social-icon circle { fill: #ff4500; }
// .social-card-9:hover .social-icon path { fill: white; }
...
//   const styleId = "social-button-styles";
