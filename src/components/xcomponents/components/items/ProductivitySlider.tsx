...
//         setTimeout(autoAdvance, 4000); // Reduced from default interval
//       });
//     };
...
//         :root {
//           --gap: 1rem;
//           --speed: 0.4s cubic-bezier(0.25, 0.46, 0.45, 0.94);
//           --closed: 4rem;
//           --open: 28rem;
//           --accent: #ff6b35;
//         }
...
//           height: 100%;
//           object-fit: cover;
//           filter: brightness(0.75) saturate(75%) blur(1px);
//           transition: filter 0.25s, transform var(--speed);
//           transform: translateZ(0);
//         }

//         .project-card:hover .project-card__bg {
//           filter: brightness(0.85) saturate(90%) blur(1px);
...
//                     <p className="project-card__desc">{p.desc}</p>
//                     <Link to="/contact">
//                       <button className="project-card__btn max-w-[120px] mt-0 md:mt-4">
//                         Contact Me
//                       </button>
//                     </Link>
//                   </div>
