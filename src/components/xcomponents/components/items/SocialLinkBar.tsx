...
const SocialLinkBar = () => {
  return (
    <StyledWrapper>
      <div className="card border-white /20 bg-black/30 hover:bg-black/50">
        <span>Social</span>
        <a
          className="social-link"
          href="https://www.youtube.com/channel/nk10nikhil"
          target="_blank"
        ...
        <a
          className="social-link"
          href="https://discord.com/users/nk10nikhil"
          target="_blank"
          rel="noopener noreferrer"
          link-name="Discord"
          title="Discord"
...
//   .card::before {
//     left: 0;
//     background: linear-gradient(45deg, #4d60b6, #5a6bc7);
//   }

//   .card::after {
//     right: 0;
//     background: linear-gradient(45deg, #4453a6, #5162b8);
//   }

//   .card:hover {
//     box-shadow: 0 8px 25px rgba(0, 0, 0, 0.3), 0 5px 15px rgba(0, 0, 0, 0.2);
...
// export default React.memo(SocialLinkBar);
