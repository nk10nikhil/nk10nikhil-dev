  ...
  return (
    <StyledWrapper>
      <div className="container">
        <div data-text="DSA" style={{ "--r": -15 } as React.CSSProperties} className="glass">
          <svg height="1.5em" version="1.1" id="_x32_" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink"
            viewBox="0 0 512 512" xmlSpace="preserve">
            <style>{`.st0{fill:white;}`}</style>
            <g>
              <path className="st0" d="M512,241.271h-42.912c-14.446,0-25.497-0.274-36.443,8.485c-9.542,7.631-13.326,16.335-21.618,27.974
		...
		c0,21.972-7.72,43.332-22.061,60.746L283.332,280.408z"/>
              <path className="st0" d="M293.1,137.492l-24.101-1.089l-8.494-22.585c-0.702-1.879-2.501-3.13-4.509-3.13
        ...
        <div data-text="Programming" style={{ "--r": 5 } as React.CSSProperties} className="glass">
        ...
        <div data-text="Problem Solving" style={{ "--r": 25 } as React.CSSProperties} className="glass">
