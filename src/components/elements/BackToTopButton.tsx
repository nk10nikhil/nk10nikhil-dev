    ...
    <StyledWrapper>
      <div className="fixed bottom-8 right-8 z-50">
        <div className="relative p-[1.5px] w-fit rounded-[0.9em] bg-gradient-to-r from-sky-500 to-pink-500 transition-all duration-400 ease-in-out group">
          ...
          <button
            className="relative text-strong py-2 px-3 rounded-xl border-none bg-black text-white cursor-pointer shadow-[2px_2px_3px_rgba(0,0,0,0.7)] transition-all duration-300 ease-in-out"
            onClick={scrollToTop}
          >
