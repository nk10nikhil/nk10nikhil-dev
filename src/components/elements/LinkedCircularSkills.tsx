    ...
    <div className=" bg-black/20 flex flex-col items-center justify-center p-4 relative overflow-hidden py-16 pb-24">
      ...
      <div className="text-center mb-16 z-10">
        <h1 className="text-white text-3xl md:text-4xl mb-4">
          These are the{" "}
          <span className="text-gradient">tools and technologies</span> I am
          currently using in my projects.
        </h1>
      ...
      <div className="relative orbital-containerLCS">
        ...
        {/* Orbital Icons */}
        <div
          className="relative -top-14 -left-20 -translate-x-1/2 -translate-y-1/2 w-full h-full"
          ...
          {[0, 45, 90, 135, 180, 225, 270, 315].map((degree, index) => (
            ...
            >
              <div className="bg-purple-900/50 p-3 rounded-full backdrop-blur-sm">
                ...
                {index % 8 === 3 && (
                  <MonitorSmartphone size={24} className="text-purple-400" />
                )}
                {index % 8 === 4 && (
                ...
                {index % 8 === 7 && (
                  <ReactIcon size={24} className="text-purple-400" />
                )}
              </div>
            </div>
          ))}
