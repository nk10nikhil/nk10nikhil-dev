...
export const sections: Section[] = [
  {
    ...
    description:
      "I will help you create a clear, consistent brand identity that connects with your audience. Whether you're building a new brand or refreshing an old one.",
    serviceTags: [
  ...
  },
  {
    ...
    description:
      "I build modern, responsive websites and web applications that are fast, secure, and easy to manage. I also use the latest technologies to create solutions that solve your business problems.",
    serviceTags: [
  ...
  },
  {
    ...
    description:
      "I develop custom software solutions tailored to your specific business needs. From concept to deployment, I ensure that your software is scalable, secure, and user-friendly.",
    serviceTags: [
  ...
  },
  {
    ...
    description:
      "I create native and cross-platform mobile applications that provide exceptional user experiences across all devices. My mobile solutions help you connect with your customers wherever they are.",
    serviceTags: [
  ...
  },
  {
    ...
    description:
      "I provide ongoing maintenance and support services to ensure your digital products continue to perform at their best. I am always ready to help you solve problems and implement improvements.",
    serviceTags: [
  ...
  },
  {
    ...
    description:
      "I ensure that your digital products meet the highest quality standards. My QA services include manual and automated testing, performance testing, and security testing to ensure your product is reliable and user-friendly.",
    serviceTags: [
  ...
  },
  {
    ...
    description:
      "I offer a range of additional services to support your digital strategy. From digital marketing to content creation, I can help you achieve your business goals with comprehensive solutions.",
    serviceTags: [
